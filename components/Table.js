...
export class Table {
  ...
  filterable() {
    const filterFlexBox = document.createElement('div');
    filterFlexBox.classList.add('filter-flex-box', 'flex-h', 'items-center');
    // create search input
    ...
    const searchOptionsLabel = document.createElement('label');
    searchOptionsLabel.textContent = 'Search by: ';
    searchOptionsLabel.classList.add('search-options-label');
    searchOptionsLabel.setAttribute('for', 'search-options');
    const searchOptions = document.createElement('select');
    searchOptions.classList.add('search-options');
    searchOptions.setAttribute('id', 'search-options');

    filterFlexBox.appendChild(searchOptionsLabel);
    filterFlexBox.appendChild(searchOptions);
    filterFlexBox.appendChild(searchInput);
    ...
    this.table.parentNode.insertBefore(filterFlexBox, this.table);
